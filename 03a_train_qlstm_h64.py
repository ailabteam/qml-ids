...
MODEL_PATH = os.path.join(OUTPUT_DIR, "qlstm_model_h64.pth")
CONFUSION_MATRIX_PATH = os.path.join(OUTPUT_DIR, "figures/confusion_matrix_h64.png")
...
# --- 1. Định nghĩa Mạch Lượng tử (Giữ nguyên) ---
...
# (Các hàm train, evaluate, plot_confusion_matrix giữ nguyên y hệt,
# chỉ cần thay đổi title của plot)
...
def plot_confusion_matrix(y_true, y_pred, save_path):
    ...
    # --- THAY ĐỔI TITLE ---
    plt.title('Confusion Matrix (QLSTM, hidden_size=64)')
...
def main():
    ...
    hidden_size = 64 # TĂNG HIDDEN SIZE
    model = QLSTM(input_size, hidden_size, N_QUBITS, Q_DEPTH).to(DEVICE)
    print("Thử nghiệm A: Tăng hidden_size của LSTM")
    ...
    print("\n--- Kết quả Đánh giá (Thử nghiệm A: hidden_size=64) ---")
